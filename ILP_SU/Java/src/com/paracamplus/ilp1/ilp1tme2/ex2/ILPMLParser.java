...
public class ILPMLParser extends com.paracamplus.ilp1.parser.ilpml.ILPMLParser{
	...
	public IASTprogram getProgram() throws ParseException {
		try {
			IASTvisitor<Integer, Void, Throwable> c = new CountConstants();
			...
			try {
				System.out.println("nombre Conste "+ tree.node.getBody().accept(c,null));
			} catch (Throwable e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			System.out.println("nombre de Constantes = "+extractor.getCPTConst());
