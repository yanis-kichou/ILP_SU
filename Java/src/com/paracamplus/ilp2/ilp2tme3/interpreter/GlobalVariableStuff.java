...
public class GlobalVariableStuff {
    public static void fillGlobalVariables (
        ...
        env.addGlobalVariableValue(new Sinus("sinus"));
        env.addGlobalVariableValue(new MakeVector("makeVector"));
        env.addGlobalVariableValue(new VectorGet("vectorGet"));
        env.addGlobalVariableValue(new VectorLength("vectorLength"));
    }
}
