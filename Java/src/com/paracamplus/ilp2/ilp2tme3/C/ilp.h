...
extern ILP_Object ILP_sinus (ILP_Object v);
extern ILP_Object ILP_makeVector (ILP_Object v,ILP_Object o);
extern ILP_Object ILP_vectorGet (ILP_Object v,ILP_Object o);
